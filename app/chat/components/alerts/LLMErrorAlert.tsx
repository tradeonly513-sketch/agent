...
import type { LlmErrorAlertType } from '~/shared/types/actions';
...
export default function LlmErrorAlert({ alert, clearAlert, retryMessage }: Props) {
  const { title, description, isRetryable, retryCount, maxRetries, provider, errorType } = alert;
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            ...
            >
              ...
              {canRetry && (
                <p className="text-xs mt-2 text-bolt-elements-textSecondary">
            ...
            >
              <div className="flex gap-2">
                {canRetry && (
                  ...
                  >
                    <div className="i-ph:arrow-clockwise"></div>
