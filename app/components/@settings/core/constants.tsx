...
export const TAB_ICONS: Record<TabType, React.ComponentType<{ className?: string }>> = {
  ...
  github: () => <span className="i-ph:github-logo-fill" />,
  gitlab: () => <span className="i-ph:gitlab-logo-fill" />,
  netlify: Database,
  vercel: Cloud,
  supabase: Database,
  connection: Database,
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'connection', visible: true, window: 'user' as const, order: 9 },
  ...
  { id: 'profile', visible: true, window: 'user' as const, order: 13 },
  { id: 'settings', visible: true, window: 'user' as const, order: 14 },
