...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with vlyx.ide
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
              doc.text('vlyx.ide - Professional AI Development Environment', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by vlyx.ide', margin, doc.internal.pageSize.getHeight() - 10);
