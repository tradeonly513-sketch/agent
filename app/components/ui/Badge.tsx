  ...
  'inline-flex items-center gap-1 transition-colors focus:outline-none focus:ring-2 focus:ring-bolt-elements-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        primary: 'bg-purple-500/10 text-purple-600',
        success: 'bg-green-500/10 text-green-600',
        warning: 'bg-yellow-500/10 text-yellow-600',
        danger: 'bg-red-500/10 text-red-600',
        info: 'bg-blue-500/10 text-blue-600',
        subtle:
          'border border-bolt-elements-borderColor/30 bg-bolt-elements-background/50 backdrop-blur-sm text-bolt-elements-textSecondary',
      },
      size: {
