  ...
  ({ side = 'right', className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={classNames(sheetVariants({ side }), className)} {...props}>
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-bolt-elements-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-bolt-elements-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-bolt-elements-item-backgroundAccent">
          <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={classNames('text-lg font-semibold text-bolt-elements-textPrimary', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={classNames('text-sm text-bolt-elements-textSecondary', className)}
    {...props}
  />
));
