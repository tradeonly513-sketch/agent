...
export default class GroqProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    ...
    { name: 'llama-3.1-8b-instant', label: 'Llama 3.1 8b Instant (Groq)', provider: 'Groq', maxTokenAllowed: 131072 },
    {
      ...
      label: 'Llama 3.1 70b Versatile (Groq)',
      provider: 'Groq',
    ...
    { name: 'llama-3.2-3b-preview', label: 'Llama 3.2 3b Preview (Groq)', provider: 'Groq', maxTokenAllowed: 8000 },
    {
      ...
      label: 'Llama 3.2 11b Vision (Groq)',
      provider: 'Groq',
      maxTokenAllowed: 8000,
    },
    {
      name: 'llama-3.2-90b-vision-preview',
      label: 'Llama 3.2 90b Vision (Groq)',
      provider: 'Groq',
      maxTokenAllowed: 8000,
    },
    ...
    },
    {
      ...
      label: 'Llama 3.3 70b Speculative Decoding (Groq)',
      provider: 'Groq',
      maxTokenAllowed: 131072,
    },
    ...
    },
    {
      ...
      label: 'Deepseek R1 Distill Qwen 32b (Groq)',
      provider: 'Groq',
      maxTokenAllowed: 131072,
    },
    ...
    // Speculative Decoding Models
    {
      ...
      label: 'Deepseek R1 Distill Llama 70b SpecDec (Groq)',
      provider: 'Groq',
      maxTokenAllowed: 131072,
    },
