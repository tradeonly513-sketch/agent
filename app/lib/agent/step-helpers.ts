...
root.render(
  ...
  static getExpressFileCreationCalls(task: AgentTask): Array<{name: string, parameters: any}> {
    const calls = [];
...
app.listen(PORT, () => {
  ...
  static getHtmlFileCreationCalls(task: AgentTask): Array<{name: string, parameters: any}> {
    return [{
      name: 'create_file',
      parameters: {
        path: 'index.html',
...
<body>
  ...
  static getPythonFileCreationCalls(task: AgentTask): Array<{name: string, parameters: any}> {
    return [{
      name: 'create_file',
      parameters: {
        path: 'main.py',
...
if __name__ == "__main__":
  ...
  static getGenericFileCreationCalls(task: AgentTask, step: AgentStep): Array<{name: string, parameters: any}> {
  ...
  static getCommandExecutionCalls(step: AgentStep, task: AgentTask): Array<{name: string, parameters: any}> {
    const calls = [];
  ...
  static getDirectoryCreationCalls(task: AgentTask): Array<{name: string, parameters: any}> {
    const calls = [];
...
This file was generated by the Agent based on: ${description}`;
  ...
  static generateStepSummary(step: AgentStep, toolCalls: Array<{name: string, parameters: any}>): string {
