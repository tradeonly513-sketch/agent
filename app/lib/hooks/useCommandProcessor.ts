...
export function useCommandProcessor(options: UseCommandProcessorOptions = {}): UseCommandProcessorReturn {
  ...
  const { workingDirectory = '/home/project', onCommandExecuted, onInputModified } = options;
        ...
        for (const command of commands) {
          try {
            ...
            if (result.modifiedInput) {
              modifiedInput = modifiedInput ? `${modifiedInput}\n${result.modifiedInput}` : result.modifiedInput;
            }
